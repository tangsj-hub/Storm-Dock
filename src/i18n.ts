...
const resources = {
  zh: { translation: {
    ...
    current: "使用中", switch: "切换", retry: "重试", usage: "用量", launchGrokBot: "启动 Grok Bot", grokBotLaunched: "Grok Bot 已启动。", grokBotAlreadyActive: "Grok Bot 已登录此账号。", grokBotSwitchTitle: "Grok Bot 正在运行", grokBotSwitchDescription: "Grok Bot 将正常退出，然后以 {{account}} 重新启动。", grokBotSwitchWarning: "正常退出可能丢失 Grok Bot 中未保存的内容。", grokBotSwitchConfirm: "退出并重新启动", delete: "删除", remove: "删除 {{account}}", drag: "拖动 {{account}}", viewUsage: "查看 {{account}} 的用量", exportAccount: "导出 {{account}}",
    usageTitle: "Cursor用量", usageRefresh: "刷新用量", usageLoading: "正在查询 Cursor 用量...", usageRefreshed: "用量已更新。", usagePrimary: "Cursor Models", usageOnDemand: "Other Models", usageGrokBot: "Grok Bot", usageUsed: "{{label}} 已用 {{amount}}", usageUsedWithLimit: "{{label}} 已用 {{amount}}（{{percent}}%）", usageReset: "重置日期", usageResetsIn: "将在 {{count}} 天后重置", usageResetsToday: "今天重置", usageResetPassed: "重置日期已过", usageModels: "按模型用量", usageWeekly: "近 7 天", usageWeeklyUnavailable: "近 7 天用量暂不可用。", usageNoModels: "未返回模型请求数据。", usageUnknown: "--", usageAccountMismatch: "返回的用量数据与当前账号不匹配。", usageRequests: "请求", usageUnits: "加权单位", usageCheckedAt: "更新于 {{time}}", usageEmptyTitle: "暂无用量数据", usageEmptyDescription: "刷新后将在这里保存该账号的最近一次用量。",
  ...
  en: { translation: {
    ...
    current: "Current", switch: "Switch", retry: "Retry", usage: "Usage", launchGrokBot: "Launch Grok Bot", grokBotLaunched: "Grok Bot launched.", grokBotAlreadyActive: "Grok Bot is already signed in with this account.", grokBotSwitchTitle: "Grok Bot is running", grokBotSwitchDescription: "Grok Bot will quit normally, then restart with {{account}}.", grokBotSwitchWarning: "Quitting normally may still lose unsaved work in Grok Bot.", grokBotSwitchConfirm: "Quit and restart", delete: "Delete", remove: "Delete {{account}}", drag: "Drag {{account}}", viewUsage: "View usage for {{account}}", exportAccount: "Export {{account}}",
