...
Object.assign(resources.zh.translation, {
  ...
  modelCenter: "模型中心", modelCenterOnDevice: "本机", modelCenterOnDeviceLabel: "本机模型",
  ...
  downloadQueued: "排队中", downloadInterrupted: "未完成", downloadPaused: "已暂停", downloadPause: "暂停下载", downloadRetryWait: "等待重试", downloadVerifying: "正在校验", downloadVerified: "已完成并校验", downloadWeaklyVerified: "已完成（弱校验）", downloadRemove: "删除任务和文件", downloadError: "下载失败", downloadComplete: "已完成",
...
Object.assign(resources.en.translation, {
  ...
  aboutCopyright: "© {{year}} Storm Dock",
  modelCenter: "Model Center", modelCenterOnDevice: "On device", modelCenterOnDeviceLabel: "On-device models",
