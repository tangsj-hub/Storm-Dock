...
const resources = {
  zh: { translation: {
    ...
    usageTitle: "Cursor 用量", usageRefresh: "刷新用量", usageLoading: "正在查询 Cursor 用量...", usageRefreshed: "用量已更新。", usagePrimary: "套餐用量", usageOnDemand: "按需用量", usageReset: "重置日期", usageResetsIn: "将在 {{count}} 天后重置", usageResetsToday: "今天重置", usageResetPassed: "重置日期已过", usageModels: "按模型用量", usageWeekly: "近 7 天", usageWeeklyUnavailable: "近 7 天用量暂不可用。", usageNoModels: "未返回模型请求数据。", usageUnknown: "--", usageRequests: "请求", usageUnits: "加权单位", usageCheckedAt: "更新于 {{time}}", usageEmptyTitle: "暂无用量数据", usageEmptyDescription: "刷新后将在这里保存该账户的最近一次用量。",
    officialLogin: "官方登录", importCurrent: "导入当前账户", tokenImport: "Token / JSON",
    officialLoginTitle: "官方登录", officialLoginDescription: "打开 Cursor 官方授权页，使用与 Cursor CLI 相同的 OAuth / PKCE 流程完成登录并导入账户。", startLogin: "开始登录", officialLoginWaiting: "请在浏览器中完成 Cursor 登录。授权完成后会自动导入账户。", officialLoginImporting: "正在导入官方登录会话...", officialLoginOpenBrowser: "重新打开授权页", cancelLogin: "取消登录", officialLoginCancelled: "已取消官方登录。",
    importCurrentTitle: "导入当前账户", importCurrentDescription: "读取当前 Cursor 的登录账户并加入列表。", cursorNotReady: "Cursor 未就绪。",
    tokenImportTitle: "Token / JSON 导入", tokenImportDescription: "粘贴 Access Token、JWT、user_01…::token 会话凭证或导出的 Cursor JSON。", tokenExampleTitle: "示例格式", tokenExampleSession: "会话凭证", tokenExampleJwt: "JWT / Access Token", tokenExampleJson: "JSON", credential: "凭证内容", cancel: "取消", import: "导入账户",
  ...
  en: { translation: {
    ...
    usageTitle: "Cursor usage", usageRefresh: "Refresh usage", usageLoading: "Fetching Cursor usage...", usageRefreshed: "Usage updated.", usagePrimary: "Plan usage", usageOnDemand: "On-demand usage", usageReset: "Reset date", usageResetsIn_one: "Resets in {{count}} day", usageResetsIn_other: "Resets in {{count}} days", usageResetsToday: "Resets today", usageResetPassed: "Reset date has passed", usageModels: "Usage by model", usageWeekly: "Last 7 days", usageWeeklyUnavailable: "Last 7 days usage is unavailable.", usageNoModels: "No model request data was returned.", usageUnknown: "--", usageRequests: "requests", usageUnits: "weighted units", usageCheckedAt: "Updated {{time}}", usageEmptyTitle: "No usage data yet", usageEmptyDescription: "Refresh to save the latest usage for this account here.",
    ...
    tokenImportTitle: "Import Token / JSON", tokenImportDescription: "Paste an access token, JWT, user_01…::token session credential, or exported Cursor JSON.", tokenExampleTitle: "Example formats", tokenExampleSession: "Session token", tokenExampleJwt: "JWT / Access Token", tokenExampleJson: "JSON", credential: "Credential", cancel: "Cancel", import: "Import account",
